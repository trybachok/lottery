...
public final class UnsupportedPaymentProviderAdapter implements PaymentProviderPort {
    @Override
    ...
    private ApplicationException notConfigured() {
        return new ApplicationException("PAYMENT_PROVIDER_NOT_CONFIGURED", "Payment provider adapter is not configured");
    }
}

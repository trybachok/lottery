...
Миграции создают роли и permissions, но не создают пользователя-администратора. Первый администратор создается автоматически при первой регистрации пользователя с логином `owner`.

...
] satisfies Array<{ key: keyof Draw; label: string; align?: 'left' | 'right' | 'center' }>
...
<template>
  <BaseCard title="Draw report" description="Filtered draw report rows returned by the backend.">
    <BaseTable :columns="columns" :rows="draws" empty-message="No draws match the selected filters">
